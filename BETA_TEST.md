...
> (aunque si un número te parece raro, ¡avisanos igual!).

## Cómo empezar

1. Abrí la aplicación (ver el [manual de instalación](docs/usuario/instalacion.md)).
2. Hacé clic en **"Cargar ejemplo"** para ver cómo se comporta con datos completos.
3. Después usá **"Limpiar"** y cargá los datos de **tu** establecimiento.

## Qué nos interesa que pruebes

- **Cargar tus datos reales** en todas las secciones del formulario y ver si los
  resultados te resultan **coherentes y entendibles**.
...
- La app se **traba**, queda en blanco, o aparece un mensaje de error.
- Algo **no se ve bien** o **no responde** (especialmente en celular).
- Un **texto confuso** o un paso difícil de entender.
...
- No necesitás instalar nada complicado ni saber de computación.
- No hace falta que verifiques las fórmulas contra el Excel: **de eso nos encargamos
  nosotros** en la etapa de auditoría.

¡Gracias por tu tiempo! Cada reporte ayuda a que la versión final sea mejor.
